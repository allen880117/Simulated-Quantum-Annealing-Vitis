...
fp_t Run(
    // Spins
    const spin_pack_t trotters[NUM_SPIN / PACKET_SIZE],
    // Jcoup
...
#pragma HLS ARRAY_PARTITION dim = 2 type = cyclic factor = 2 variable = trottersLocal
...
#pragma HLS ARRAY_PARTITION dim = 2 type = cyclic factor = 2 variable = JcoupLocal
    //    CTX_PRAGMA(HLS ARRAY_PARTITION dim = 2 type = cyclic factor =
...
#pragma HLS UNROLL
        ...
        downSpin[NUM_TROT - 1] = trottersLocal[0][iPack[NUM_TROT - 1]][iSpin[NUM_TROT - 1]];
